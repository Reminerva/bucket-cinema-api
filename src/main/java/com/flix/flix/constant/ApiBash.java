...
public class ApiBash {
    ...
    public static final String STUDIO = "/api/v1/studio";
    public static final String PRODUCT_PRICING_SCHEDULING = "/api/v1/product-pricing-scheduling";
    ...
    public static final String GET_STUDIO_SUCCESS = "Get studio success";
